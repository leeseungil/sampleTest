    ...
    >
      <div class="boxed-container w-full">
        <div class="d-flex align-center mx-6">
          ...
          <span class="font-weight-semibold">Login : {{ $store.state.userInfo.userName }} / {{ $store.state.userInfo.loginId }}</span>
          <!-- <v-text-field
            rounded
            dense
            outlined
            hide-details
            :value="'Login : ' + loginUserInfo.userName + ' / ' + '' + loginUserInfo.loginId"
          ></v-text-field> -->
...
import { mdiMagnify, mdiBellOutline, mdiGithub, mdiAccountCheck } from '@mdi/js'
...
export default {
  ...
  setup(props, { root }) {
    ...
    const loginUserInfo = computed(() => root.$store.state.userInfo)
